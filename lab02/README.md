...
## Вывод
- При наибольшем шаге, температура заметно завышена. Но при этом, если уменьшить шаг до 0.01, шаг будет стабилизироваться до значения 20.02 и в качестве доказательства о достижении сеточной сходимости, уменьшения шага никак не меняет результат.
